layui.use(['jquery', 'layer', 'element', 'laypage', 'laytpl', 'form'], function () {
    ...
    */
    $("#btn_add").on("click", function () {
        ...
        layer.open({
          ...
          , shade: 0
          , maxmin: true
          , content: '/Pages/Goods/GoodInfo.html'
    ...
    */
    $("#btn_del").on("click", function () {
        ...
        layer.confirm('确认删除？', {
            ...
            $.post(SysConfig.API.GetGoodData, parms, function (data) {
    ...
    */
    var LoadPage = function (pageid, pdata) {
        var parms = { action: "GetOutOfStockList", pid: pageid, psize: 10 };

        ComMethod.AddGroupJson(parms, pdata);//叠加搜索参数

        $.post(SysConfig.API.GetMachineSalesInfoData, parms, function (data) {
